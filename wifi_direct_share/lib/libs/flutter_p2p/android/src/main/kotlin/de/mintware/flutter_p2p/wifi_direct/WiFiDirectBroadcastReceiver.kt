...
class WiFiDirectBroadcastReceiver(private val manager: WifiP2pManager,
    ...
    private fun onConnectionChanged(intent: Intent) {
        val p2pInfo : WifiP2pInfo = (intent.getParcelableExtra<Parcelable>(WifiP2pManager.EXTRA_WIFI_P2P_INFO) as WifiP2pInfo)
        val networkInfo : NetworkInfo = (intent.getParcelableExtra<Parcelable>(WifiP2pManager.EXTRA_NETWORK_INFO) as NetworkInfo)
    ...
    private fun onThisDeviceChanged(intent: Intent) {
        val device : WifiP2pDevice = (intent.getParcelableExtra<Parcelable>(WifiP2pManager.EXTRA_WIFI_P2P_DEVICE) as WifiP2pDevice)
